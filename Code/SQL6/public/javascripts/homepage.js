...
function hotelQuery()
{
	...
	$.ajax({
		...
		url: './hotelsByLocation', //Same URL is associated on the server
		contentType: 'application/json',
		success: function (data) {
...
function bookingCount(Id)
{
	...
	$.ajax({
		type: 'POST',
		data: JSON.stringify(query), //Must stringify all JSON objects before sending
		url: './bookingById', //Same URL is associated on the server
		contentType: 'application/json',
		success: function (data) {
...
function cancelCount(Id)
{
	...
	$.ajax({
		type: 'POST',
		data: JSON.stringify(query), //Must stringify all JSON objects before sending
		url: './cancelById', //Same URL is associated on the server
		contentType: 'application/json',
		success: function (data) {
			var chart = $("#bookcancelpie").CanvasJSChart();
